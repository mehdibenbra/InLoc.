...
public class nextlondonculture extends AppCompatActivity {
    ...
    private TextView FourteenTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nextlondonculture);
        ...
        FourteenTextView = (TextView) findViewById(R.id.ThirteenTextView);
